  ...
  const forgotPasswordHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "http://localhost:5000/api/data/checkEmail", // Replace with your API endpoint to check email existence
        { email },
        config
      );
      ...
      if (data.emailExists) {
        ...
        const response = await axios.post(
          "http://localhost:5000/api/data/forgotpassword", // Replace with your API endpoint to send the email
          { email },
          config
        );
            ...
            <div className="contain">
                ...
                <div className="login-contain p-2">
                    <form onSubmit={forgotPasswordHandler}>
                        ...
                        <div>
                            <p>Remember your password? <Link to="/admin/adminlogin">Login</Link></p>
                        </div>
